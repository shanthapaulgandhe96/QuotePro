...
//
//    override suspend fun getCurrencyRates(baseCurrency: String): Flow<Result<List<Currency>>> = flow {
//        try {
...
//                    val targetCurrency = currencies.find { it.base == toCurrency }
//
//                    if (targetCurrency != null) {
//                        val convertedAmount = amount * targetCurrency.rates
...
//    }
//
//    private fun buildCurrencyList(rates: Map<String, Double>): List<Currency> {
